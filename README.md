...
here. Species native to your region get added to your personal **dex**; species
...
| **[TEAMMATE 2]** | Game / dex UI | `client/src/views/PhotoCapture.jsx`, `DexView.jsx` — capture flow, catch vs. threat, collection |
...
client/          Vite + React app
  ...
  src/views/       PhotoCapture, DexView, MapView, RegionDashboard
